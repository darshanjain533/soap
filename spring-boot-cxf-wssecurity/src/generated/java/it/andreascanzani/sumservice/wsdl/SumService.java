 ...
 * 2021-10-01T14:28:46.633+05:30
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "SumService",
                  wsdlLocation = "file:/H:/git/medium-blog-digital-software-architecture/spring-boot-cxf-wssecurity/spring-boot-cxf-wssecurity/src/main/resources/wsdl/SumService.wsdl",
...
public class SumService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/H:/git/medium-blog-digital-software-architecture/spring-boot-cxf-wssecurity/spring-boot-cxf-wssecurity/src/main/resources/wsdl/SumService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SumService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/H:/git/medium-blog-digital-software-architecture/spring-boot-cxf-wssecurity/spring-boot-cxf-wssecurity/src/main/resources/wsdl/SumService.wsdl");
        }
        WSDL_LOCATION = url;
    }
